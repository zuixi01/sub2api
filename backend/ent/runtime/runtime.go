...
func init() {
	...
	// userDescAffiliateAuthorized is the schema descriptor for affiliate_authorized field.
	userDescAffiliateAuthorized := userFields[7].Descriptor()
	// user.DefaultAffiliateAuthorized holds the default value on creation for the affiliate_authorized field.
	user.DefaultAffiliateAuthorized = userDescAffiliateAuthorized.Default.(bool)
