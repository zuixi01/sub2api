...
type User struct {
	...
	// AffiliateAuthorized holds the value of the "affiliate_authorized" field.
	AffiliateAuthorized bool `json:"affiliate_authorized,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldAffiliateAuthorized, user.FieldTotpEnabled, user.FieldBalanceNotifyEnabled:
	...
	for i := range columns {
		...
		case user.FieldAffiliateAuthorized:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field affiliate_authorized", values[i])
			} else if value.Valid {
				_m.AffiliateAuthorized = value.Bool
			}
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("affiliate_authorized=")
	builder.WriteString(fmt.Sprintf("%v", _m.AffiliateAuthorized))
	builder.WriteString(", ")
